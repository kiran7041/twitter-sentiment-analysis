...
FREQ_DIST_FILE = './train_data_modified-processed-freqdist.pkl'
BI_FREQ_DIST_FILE = './train_data_modified-processed-freqdist-bi.pkl'
TRAIN_PROCESSED_FILE = 'train_data_modified-processed.csv'
TEST_PROCESSED_FILE = 'test_data_modified-processed.csv'
...
if __name__ == '__main__':
    ...
    if train:
        model = Sequential()
        #embedding_layer= Embedding(vocab_size + 1,dim, input_length=max_length)
        #embedding_layer= Embedding(vocab_size + 1,dim,input_length=max_length)

        # Set the pre-trained GloVe vectors as weights
